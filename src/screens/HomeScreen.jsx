...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative">
      ...
      {/** circles section */}
      <View className="w-[400px] h-[400px] bg-[#00bcc9] rounded-full absolute bottom-36 -right-40">
      </View>
      <View className="w-[400px] h-[400px] bg-[#e99265] rounded-full absolute -bottom-28 -left-40">
      </View>
      ...
      <View className="flex-1 relative items-center justify-center">
        ...
        <View className="absolute bottom-20 w-24 h-24 border-l-2 border-r-4 border-t-4 border-[#00bcc9] rounded-full items-center justify-center">
          <TouchableOpacity>
